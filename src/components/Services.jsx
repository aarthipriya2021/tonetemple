    ...
    <div id="services" className="container pb-4">
      <div className="row align-items-center">
        ...
        <div className="col-md-6 text-sm-start text-center">
          ...
          <p className="mb-4">
          We have created a supportive and motivating environment at our gym, where clients feel empowered to push themselves and achieve their fitness potential.
          </p>
