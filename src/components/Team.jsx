      ...
      <div className="row">
        <div className="col-lg-3 col-md-6 mb-5">
          <div className="card border-0 bg-secondary text-center text-white">
            ...
            <div className="card-body bg-secondary">
              <h4 className="card-title">Coach Steve</h4>
              <p className="card-text">Coach</p>
            </div>
          </div>
        </div>
        <div className="col-lg-3 col-md-6 mb-5">
          <div className="card border-0 bg-secondary text-center text-white">
            ...
            <div className="card-body bg-secondary">
              <h4 className="card-title">Trainer Alex</h4>
        ...
        <div className="col-lg-3 col-md-6 mb-5">
          <div className="card border-0 bg-secondary text-center text-white">
            ...
            <div className="card-body bg-secondary">
              <h4 className="card-title ">Fitness Pro Sarah</h4>
              <p className="card-text">Trainer</p>
            </div>
          </div>
        </div>
        <div className="col-lg-3 col-md-6 mb-5">
          <div className="card border-0 bg-secondary text-center text-white">
            ...
            <div className="card-body bg-secondary">
              <h4 className="card-title ">Coach James</h4>
              <p className="card-text">Trainer</p>
            </div>
          </div>
        </div>
